...
+
image::cloud-guides/{page-image-directory}/sagemaker.notebook.create.lifecycle.config.png[create a lifecycle configuration for notebook instance, width=75%]
...
+
image::cloud-guides/{page-image-directory}/sagemaker.notebook.create.notebook.instance.png[Create notebook instance, width=75%]
+
...
+
image::cloud-guides/{page-image-directory}/sagemaker.notebook.start.png[access demo notebooks, width=75%]

...
1. Start the new connection wizard by clicking on the plug icon (image:other-integrations/{page-image-directory}/plug-icon.png[title="Add Connection Plug Icon", width="16px"]) in the upper left corner of the application window or go to `Database -> New Database Connection`.
...
+
image::other-integrations/{page-image-directory}/teradata-connection-settings.png[Teradata connection settings, width=75%]
4. Click on `Finish`.
...
image::other-integrations/{page-image-directory}/teradata-connection-settings-ssh.png[Teradata connection settings SSH, width=75%]

...
image::cloud-guides/{page-image-directory}/image2.png[Diagram Description automatically generated,width=584,height=262]
...
image::cloud-guides/{page-image-directory}/image3.png[A screenshot of a social media post Description automatically generated,width=624,height=418]
...
+
image::cloud-guides/{page-image-directory}/image4.png[A screenshot of a cell phone Description automatically generated,width=624,height=392]
...
+
image::cloud-guides/{page-image-directory}/image5.png[A screenshot of a cell phone Description automatically generated,width=544,height=327]

* At the salesforce login window, enter your *Username* and *Password*. Click *Log In*
+
image::cloud-guides/{page-image-directory}/image6.png[A screenshot of a cell phone Description automatically generated,width=477,height=377]

* Click *Allow* to allow AppFlow to access your salesforce data and information.
+
image::cloud-guides/{page-image-directory}/image7.png[A screenshot of a cell phone Description automatically generated,width=473,height=383]

* Back at the AppFlow *Configure flow* window, use *Salesforce objects*, and choose _Account_ to be the Salesforce object.
+
image::cloud-guides/{page-image-directory}/image8.png[A screenshot of a cell phone Description automatically generated,width=624,height=390]
+
image::cloud-guides/{page-image-directory}/image9.png[A screenshot of a cell phone Description automatically generated,width=624,height=389]
...
+
image::cloud-guides/{page-image-directory}/image10.png[A screenshot of a cell phone Description automatically generated,width=624,height=355]

* *Flow trigger* is _Run on demand_. Click *Next*.
+
image::cloud-guides/{page-image-directory}/image11.png[A screenshot of a cell phone Description automatically generated,width=624,height=344]
...
+
image::cloud-guides/{page-image-directory}/image12.png[A screenshot of a cell phone Description automatically generated,width=623,height=355]
+
...
+
image::cloud-guides/{page-image-directory}/image13.png[A screenshot of a cell phone Description automatically generated,width=624,height=132]
...
image::cloud-guides/{page-image-directory}/image14.png[A screenshot of a cell phone Description automatically generated,width=624,height=179]
...
image::cloud-guides/{page-image-directory}/image15.png[A screenshot of a cell phone Description automatically generated,width=624,height=226]
...
image::cloud-guides/{page-image-directory}/image17.png[A screenshot of a social media post Description automatically generated,width=551,height=366]

Click on the _AWS-KMS_ from *Encryption* and change it from _AWS-KMS_ encryption to _None_. Click *Save*.

image::cloud-guides/{page-image-directory}/image18.png[A screenshot of a social media post Description automatically generated,width=548,height=285]
...
image::cloud-guides/{page-image-directory}/image19.png[A picture containing monitor Description automatically generated,width=624,height=257]

Sample output form "SELECT payload.* FROM salesforce;".

image::cloud-guides/{page-image-directory}/image20.png[A screenshot of a cell phone Description automatically generated,width=624,height=257]
...
image::cloud-guides/{page-image-directory}/image21.png[A screenshot of a cell phone Description automatically generated,width=196,height=225]
...
image::cloud-guides/{page-image-directory}/image22.png[A picture containing computer Description automatically generated,width=624,height=98]
...
image::cloud-guides/{page-image-directory}/image23.png[A screenshot of a cell phone Description automatically generated,width=321,height=234]
...
image::cloud-guides/{page-image-directory}/image28.png[A screenshot of a computer Description automatically generated,width=624,height=96]
...
image::cloud-guides/{page-image-directory}/image29.png[A picture containing large, people, riding Description automatically generated,width=624,height=97]
...
image::cloud-guides/{page-image-directory}/image30.png[A picture containing people Description automatically generated,width=624,height=95]
...
+
image::cloud-guides/{page-image-directory}/image43.png[Graphical user interface, application, table Description automatically generated,width=624,height=396]
+
...
image::cloud-guides/{page-image-directory}/image46.png[Graphical user interface, application Description automatically generated,width=624,height=288]

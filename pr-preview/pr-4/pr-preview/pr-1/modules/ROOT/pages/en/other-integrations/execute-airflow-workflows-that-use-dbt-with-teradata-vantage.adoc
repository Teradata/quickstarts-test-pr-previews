...
+
image::other-integrations/{dir}/admin-dropdown.png[Airflow admin dropdown, width=75%]
* Click on `Choose File`, then select `variable.json` in your file explorer and click on `Import Variables`
+
image::other-integrations/{dir}/import-variables.png[Airflow admin dropdown, width=75%]

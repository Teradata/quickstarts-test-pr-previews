...
Reference: xref::en/mule-teradata-connector/reference.adoc[Teradata Connector Reference]
...
* xref::en/mule-teradata-connector/examples-configuration.adoc[Using Anypoint Studio to Configure Teradata Connector]

...
image::business-intelligence/{page-image-directory}/power.bi.elements.png[Power BI elements, width=100%]
...
image::business-intelligence/{page-image-directory}/power.bi.overview.blocks.png[Power BI overview blocks, width=100%]
...
image::business-intelligence/{page-image-directory}/power.bi.icon.png[Power BI icon, width=30%]

* If the opening (splash) screen is showing, click on Get data.

image::business-intelligence/{page-image-directory}/power.bi.splash.screen.png[Power BI splash screen, width=70%]
...
image::business-intelligence/{page-image-directory}/power.bi.get.data.menu.png[Power BI Get Data menu, width=70%]
...
image::business-intelligence/{page-image-directory}/power.bi.database.picker.png[Power BI Database picker, width=70%]
...
image::business-intelligence/{page-image-directory}/power.bi.server.connect.png[Power BI server connection, width=70%]
...
image::business-intelligence/{page-image-directory}/power.bi.ldap.png[Power BI LDAP connection, width=70%]
...
image::business-intelligence/{page-image-directory}/power.bi.publish.png[Power BI Publish, width=100%]

Power BI Desktop will prompt you to save your report. Choose _My workspace_ and click _Select_. 

image::business-intelligence/{page-image-directory}/power.bi.workspace.png[Power BI publish to my workspace, width=90%]

Once report has been published, click _Got it_ to close. You may also click the link, which has the report name in the link.

image::business-intelligence/{page-image-directory}/power.bi.success.png[Power BI successfully published, width=90%]

This is an example of a report created in Power BI Desktop.

image::business-intelligence/{page-image-directory}/power.bi.report.png[Power BI Report, width=100%]
...
== Getting help
If you have any questions or need further assistance, please visit our https://support.teradata.com/community?id=community_forum&sys_id=9ebf975e1bf7f304682ca8233a4bcb8a[community forum] where you can get support and interact with other community members.

...
image::regulus/regulus-magic-reference/regulus.project.list.png[List Project, width=500]
...
image::regulus/{page-image-directory}/regulus.auth.list.png[List Auth, width=500]
...
image::regulus/{page-image-directory}/regulus.engine.deploy.png[Deploy Engine, width=500]
...
image::regulus/{page-image-directory}/regulus.engine.list.png[Engine List, width=500]
...
image::regulus/{page-image-directory}/regulus.user.list.png[User List, width=500]

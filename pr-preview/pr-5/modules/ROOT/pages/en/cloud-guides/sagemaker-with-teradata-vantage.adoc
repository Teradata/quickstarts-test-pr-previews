...
+
image::cloud-guides/{page-image-directory}/create.notebook.png[Create notebook instance]

2.	Open your notebook instance:
+
image::cloud-guides/{page-image-directory}/open.notebook.instance.png[Open notebook instance]

3. Start a new file by clicking on `New -> conda_python3`:
+
image::cloud-guides/{page-image-directory}/start.new.file.png[Start new file]
...
+
image::cloud-guides/{page-image-directory}/resource.configuration.png[Resource configuration,width=50%]
...
image::cloud-guides/{page-image-directory}/attach.endpoint.configuration.png[Attach endpoint configuration]

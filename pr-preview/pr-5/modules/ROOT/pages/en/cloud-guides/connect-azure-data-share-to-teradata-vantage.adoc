...
* Click *Add datasets*.
+
image::cloud-guides/{page-image-directory}/image10.png[Dataset added to Sent Shares,image,width=624,height=242]
...
+
image::cloud-guides/{page-image-directory}/image11.png[Add recipient email address,image,width=624,height=180]
...
+
image::cloud-guides/{page-image-directory}/image12.png[Set Snapshot schedule,image,width=437,height=299]
...
+
image::cloud-guides/{page-image-directory}/image14.png[Data Share ready and invitation sent to recipient,image,width=474,height=169]
...
+
image::cloud-guides/{page-image-directory}/image15.png[Data Share email invitation to recipient,image,width=387,height=192]

* This action opens your browser to the list of Data Share invitations.
+
image::cloud-guides/{page-image-directory}/image16.png[Data Share invitations,image,width=624,height=165]
...
+
image::cloud-guides/{page-image-directory}/image17.png[Target Data Share account,image,width=424,height=228]
...
+
image::cloud-guides/{page-image-directory}/image18.png[Select Dataset and Map to target,image,width=568,height=186]
...
+
image::cloud-guides/{page-image-directory}/image19.png[Map datasets to target,image,width=291,height=286]
...
+
image::cloud-guides/{page-image-directory}/image20.png[Trigger full or incremental snapshot,image,width=326,height=280]
...
+
image::cloud-guides/{page-image-directory}/image21.png[Dataset and target path to view shared data,image,width=623,height=118]
...
image::cloud-guides/{page-image-directory}/image22.png[WeatherData table,image,width=572,height=104]
...
image::cloud-guides/{page-image-directory}/image23.png[WeatherData table payload,width=574,height=140]
...
----
+
image::cloud-guides/{page-image-directory}/image25.png[Weather data,width=624,height=87]
...
+
image::cloud-guides/{page-image-directory}/image28.png[READ_NOS object length,image,width=623,height=30]

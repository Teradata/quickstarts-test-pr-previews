...
NOTE: If do not wish to pay for cloud usage you can install Vantage Express locally using link::getting.started.vmware.adoc[VMware], link::getting.started.vbox[VirtualBox], or xref::en/getting.started.utm.adoc[UTM].

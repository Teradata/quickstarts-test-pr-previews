...
+
image::other-integrations/{page-image-directory}/add-jar.png[Add jar, width=75%]
...
+
image::other-integrations/{page-image-directory}/register-driver.png[Register driver, width=75%]
...
+
image::other-integrations/{page-image-directory}/test-connection-1.png[Test connection step 1, width=75%]
+
image::other-integrations/{page-image-directory}/test-connection-2.png[Test connection step 2, width=75%]
7. Right-click on the `Database Reader (legacy)` to configure settings. Select `com.teradata.jdbc.Teradriver` from the drop-down:
+
image::other-integrations/{page-image-directory}/start-configuration.png[Start configuration, width=75%]
8. Enter the name of the Vantage server and login mechanism, e.g.:
+
image::other-integrations/{page-image-directory}/enter-configuration.png[Enter configuration, width=75%]
...
+
image::other-integrations/{page-image-directory}/test-connection-apply.png[Test connection apply, width=75%]
10. Execute the node to test the connection:
+
image::other-integrations/{page-image-directory}/execute-node.png[Execute node, width=75%]
11. The node will show a green light when run successfully. Right-click and select `Data from Database` to view the results:
+
image::other-integrations/{page-image-directory}/view-results.png[View results, width=75%]
+
image::other-integrations/{page-image-directory}/view-results-final.png[View results, width=75%]
...
== Further reading
* xref::en/general/ml.adoc[Train ML models in Vantage using only SQL]

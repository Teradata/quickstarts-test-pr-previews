...
* If you installed xref::en/getting.started.vbox.adoc[Vantage Express on VirtualBox], you should be able to drag & drop the file to the VM's desktop. You can also use `scp` by connecting to port `4422`, e.g.:
+

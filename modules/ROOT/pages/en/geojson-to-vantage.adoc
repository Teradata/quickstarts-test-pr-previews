...
Consider using https://pypi.org/project/teradatasqlalchemy/[SQLAlchemy ORM] if you are defining your pipeline in Python, xref::en/dbt.adoc[dbt], or your favorite ELT and orchestration toolset to create your products you can operationalize.
